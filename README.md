...
|---|---|---|
| 📄 Resume & Jobfit Analyzer | NLP-powered app that analyzes resumes against job descriptions, with a Selenium-based LinkedIn scraper for live job listings | Python, NLP, LLM, Selenium |
| [🌾 AI-Integrated Smart Farming Platform](https://github.com/Sahil3102/AI-Integrated-Smart-Farming-Platform) | Django-based smart agriculture platform with real-time weather tracking, soil analysis, and ML-driven crop recommendations | Python, Django, scikit-learn, Pandas, MySQL, REST APIs |
| [💰 Pricing Recommendation System](https://github.com/Sahil3102/Pricing-Recommendation-System) | A model that recommends optimal pricing based on product/market data | Python |
| [✉️ Email Generator AI](https://github.com/Sahil3102/Email-Generator-AI) | An AI-powered tool that automatically generates email content | Python |
| [🏦 Bank Transaction Categorization](https://github.com/Sahil3102/Bank-Transaction-Categorization) | Automatically classifies bank transactions into meaningful spending categories | Python |
